from torchvision.transforms import RandomHorizontalFlip, RandomCrop, Grayscale, ToTensor, Resize
...
train_transform = transforms.Compose([
    ...
    Grayscale(num_output_channels=3),  # Convert grayscale to 3 channels (RGB)
    RandomHorizontalFlip(),
    RandomCrop((224, 224)), # Convert PIL Image to Tensor
    ToTensor()
])
